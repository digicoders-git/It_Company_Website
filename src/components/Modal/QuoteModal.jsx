          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="bg-primary-dark p-5 relative overflow-hidden shrink-0">
                <div className="absolute top-0 right-0 w-40 h-40 rounded-full bg-primary-blue/10 translate-x-1/3 -translate-y-1/3" />
                ...
                {formStatus.type === 'success' ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        <label className="flex items-center gap-1.5 text-xs font-bold text-primary-dark mb-1 uppercase tracking-wider">
                          <User className="h-3 w-3 text-primary-blue" />
                          Your Name *
                        </label>
                        <input
                          type="text"
                          ...
                          className="w-full border-2 border-gray-200 py-2 px-3 text-sm focus:outline-none focus:border-primary-blue transition-colors"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="flex items-center gap-1.5 text-xs font-bold text-primary-dark mb-1 uppercase tracking-wider">
                          <Briefcase className="h-3 w-3 text-primary-blue" />
                          Company Name
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className="w-full border-2 border-gray-200 py-2 px-3 text-sm focus:outline-none focus:border-primary-blue transition-colors bg-white"
                        >
                    ...
                    <div>
                      <label className="flex items-center gap-1.5 text-xs font-bold text-primary-dark mb-1 uppercase tracking-wider">
                        <MessageSquare className="h-3 w-3 text-primary-blue" />
                        Project Details *
                      </label>
                      <textarea
                        name="message"
                        ...
                        className="w-full border-2 border-gray-200 py-2 px-3 text-sm focus:outline-none focus:border-primary-blue transition-colors resize-none"
                      />
                    </div>
              ...
              <div className="bg-[#F5F7F9] px-5 py-2.5 border-t border-gray-200 shrink-0">
                <p className="text-xs text-gray-600 font-medium text-center">
                  ...
                  <a href="#" className="text-primary-blue font-bold hover:underline">
                    Privacy Policy
                  </a>
                </p>
              </div>
