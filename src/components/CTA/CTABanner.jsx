...
const CTABanner = () => {
  return (
    <section className="relative overflow-hidden bg-primary-pink py-20">
      {/* Background circles */}
      ...
      <div className="container relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          >
            <a
              href="tel:5003692580"
              className="flex items-center gap-3 border-2 border-white text-white px-8 py-4 font-semibold uppercase tracking-wider text-sm hover:bg-white hover:text-primary-pink transition-all duration-300"
            >
              <Phone className="h-5 w-5" />
              500.369.2580
            </a>
            <button className="flex items-center gap-2 bg-white text-primary-pink px-8 py-4 font-semibold uppercase tracking-wider text-sm hover:bg-primary-dark hover:text-white transition-all duration-300">
