      ...
      <div className="container">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-primary-dark leading-tight">
            Latest News &{' '}
            <span className="text-primary-blue">Updates</span>
          </h2>
          ...
          {posts.map((post, idx) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-primary-blue text-white text-xs font-black uppercase tracking-wider px-3 py-1">
                  {post.category}
                </div>
              </div>
              ...
              <div className="p-8">
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-primary-blue font-black text-sm uppercase tracking-wider hover-line"
                >
