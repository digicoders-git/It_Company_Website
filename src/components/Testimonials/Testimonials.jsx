        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-primary-dark leading-tight mb-6">
              What Our Clients<br />
              <span className="text-primary-teal">Say About Us</span>
            </h2>
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={prev}
                className="h-14 w-14 flex items-center justify-center border-2 border-gray-200 text-gray-400 hover:border-primary-teal hover:bg-primary-teal hover:text-white transition-all duration-300"
              >
                <ChevronLeft className="h-6 w-6" />
              </button>
              <button
                onClick={next}
                className="h-14 w-14 flex items-center justify-center border-2 border-primary-teal bg-primary-teal text-white hover:bg-transparent hover:text-primary-teal transition-all duration-300"
              >
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Quote Icon */}
                <div className="absolute -top-5 -left-5 h-14 w-14 bg-primary-teal flex items-center justify-center">
                ...
                <div className="flex items-center gap-4 border-t border-gray-100 pt-6">
                  ...
                  <div>
                    ...
                    <p className="text-primary-teal text-sm font-semibold">{testimonials[current].role}</p>
                  </div>
                </div>

                {/* Bottom accent */}
                <div className="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-primary-teal to-primary-teal" />
              </motion.div>
            </AnimatePresence>

            {/* Decorative box */}
            <div className="absolute -bottom-4 -right-4 w-full h-full border-2 border-primary-teal/20 -z-10" />
          </div>
        </div>
      </div>
    </section>
