      ...
      <div className="container flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="tel:5003692580" className="flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-white transition-colors">
            <Phone className="h-3.5 w-3.5 text-primary-pink" />
            <span>500.369.2580</span>
          </a>

          {/* Email */}
          <a href="mailto:info@zentec.com" className="flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-white transition-colors">
            <Mail className="h-3.5 w-3.5 text-primary-pink" />
