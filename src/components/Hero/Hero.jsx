...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-white pt-8 pb-16 lg:pt-12 lg:pb-20">
      {/* Decorative Elements */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-primary-blue/5 rounded-full blur-3xl" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-primary-blue/5 rounded-full blur-3xl" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-bold leading-[1.15] text-primary-dark mb-5">
              ...
              <span className="text-primary-blue">Solutions</span> Your Way!
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex items-center gap-3 group cursor-pointer">
                <div className="relative flex h-12 w-12 items-center justify-center rounded-full bg-white border-2 border-primary-blue text-primary-blue transition-all group-hover:bg-primary-blue group-hover:text-white shadow-md">
          ...
          >
            <div className="relative">
              ...
              {/* Decorative Shape */}
              <div className="absolute -bottom-6 -right-6 w-48 h-48 border-4 border-primary-blue/20 -z-10 hidden lg:block" />
            </div>
          </motion.div>
        </div>
      </div>
