...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-white pt-8 pb-16 lg:pt-12 lg:pb-20">
      ...
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-primary-lime/5 rounded-full blur-3xl" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-primary-teal/10 px-4 py-2 mb-6"
            >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-bold leading-[1.15] text-primary-dark mb-5">
              ...
              <span className="text-primary-teal">Solutions</span> Your Way!
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <div className="flex items-center gap-3 group cursor-pointer">
                <div className="relative flex h-12 w-12 items-center justify-center rounded-full bg-white border-2 border-primary-teal text-primary-teal transition-all group-hover:bg-primary-teal group-hover:text-white shadow-md">
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 bg-primary-teal/10 rounded-lg flex items-center justify-center">
                    <span className="text-primary-teal font-black text-lg">25+</span>
                  </div>
                  <div>
              ...
              <motion.div
                ...
                className="absolute -right-6 bottom-1/4 bg-primary-teal rounded-lg shadow-2xl p-4 text-white hidden lg:block"
              >
              ...
              {/* Decorative Shape */}
              <div className="absolute -bottom-6 -right-6 w-48 h-48 border-4 border-primary-teal/20 -z-10 hidden lg:block" />
            </div>
          </motion.div>
        </div>
      </div>
