  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden bg-gray-200">
        ...
        {/* Category Badge */}
        <div className="absolute top-4 left-4 bg-primary-blue text-white text-xs font-black uppercase tracking-wider px-3 py-1 z-10">
          {caseStudy.category}
        </div>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
              ...
              <span className="text-primary-blue">Client Projects</span>
            </h1>
