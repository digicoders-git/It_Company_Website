...
import { ArrowRight, Calendar, Tag, Shield, Lock, Eye, Image as ImageIcon } from 'lucide-react';
import { Link } from 'react-router-dom';

const cyberSecurityCaseStudies = [
  {
  ...
  {
    id: 'retail-security-transformation',
    title: 'Retail Chain Security Transformation',
    client: 'ShopMax Retail',
    date: 'July 2023',
    image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&h=600&fit=crop&q=80',
    excerpt: 'Implemented comprehensive security framework protecting customer data across 500+ retail locations.',
    tags: ['Retail', 'PCI-DSS', 'Data Protection'],
  },
  {
    ...
    excerpt: 'Deployed AI-powered threat detection system identifying and neutralizing 10,000+ threats monthly.',
    tags: ['AI/ML', 'Threat Detection', 'SIEM'],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden bg-gray-200">
        ...
        {imageError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-primary-dark to-primary-blue">
        ...
        {/* Category Badge */}
        <div className="absolute top-4 left-4 bg-primary-blue text-white text-xs font-black uppercase tracking-wider px-3 py-1 z-10 flex items-center gap-1.5">
        ...
        <Link
          ...
          className="absolute bottom-4 right-4 h-12 w-12 bg-primary-blue flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 z-10"
        >
      ...
      <div className="p-8">
        ...
        <Link to={`/case-studies/${caseStudy.id}`}>
          <h3 className="text-lg font-black text-primary-dark leading-snug mb-3 group-hover:text-primary-blue transition-colors">
            {caseStudy.title}
          </h3>
        </Link>
      ...
      {/* Bottom Accent */}
      <div className="h-1 w-0 bg-primary-blue transition-all duration-500 group-hover:w-full" />
    </motion.article>
  );
};
    ...
    <>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
              Cyber Security<br />
              <span className="text-primary-blue">Case Studies</span>
            </h1>
      ...
      <section className="section-padding bg-[#F5F7F9]">
        <div className="container">
          ...
          >
            {cyberSecurityCaseStudies.map((caseStudy, idx) => (
              <CaseStudyCard key={caseStudy.id} caseStudy={caseStudy} idx={idx} />
            ))}
          </motion.div>

          {cyberSecurityCaseStudies.length === 0 && (
            ...
            {[
              {
                ...
                description: 'Comprehensive security assessments to identify vulnerabilities and recommend remediation strategies for your infrastructure.',
              },
              {
                icon: Lock,
                title: 'Compliance Management',
                description: 'Ensure compliance with GDPR, HIPAA, PCI-DSS, SOC 2, and other regulatory requirements with our expert guidance.',
              },
              {
                icon: Eye,
                title: 'Threat Monitoring',
                description: '24/7 security monitoring and incident response services to detect and neutralize threats before they impact your business.',
              },
            ].map((service, idx) => (
              <motion.div
                key={idx}
                ...
                className="bg-[#F5F7F9] p-8 text-center hover:bg-primary-blue group transition-all duration-500"
              >
                <div className="h-16 w-16 bg-primary-blue/20 flex items-center justify-center mx-auto mb-6 group-hover:bg-white/20 transition-colors">
                  <service.icon className="h-8 w-8 text-primary-blue group-hover:text-white transition-colors" />
                </div>
      ...
      <section className="section-padding bg-primary-dark">
        <div className="container">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              { count: '200+', label: 'Security Projects' },
              { count: '0', label: 'Breaches Post-Implementation' },
              { count: '100%', label: 'Compliance Achieved' },
              { count: '24/7', label: 'Security Monitoring' },
            ].map((stat, idx) => (
              <motion.div
                key={idx}
                ...
                transition={{ delay: idx * 0.1 }}
              >
                <h4 className="text-5xl font-black text-primary-blue mb-2">{stat.count}</h4>
        ...
        <div className="container text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-white text-primary-blue px-8 py-4 font-black uppercase tracking-wider text-sm hover:bg-primary-dark hover:text-white transition-all duration-300">
                Get Security Assessment <ArrowRight className="h-4 w-4 inline ml-2" />
              </button>
              <Link
                to="/case-studies"
                className="border-2 border-white text-white px-8 py-4 font-black uppercase tracking-wider text-sm hover:bg-white hover:text-primary-blue transition-all duration-300 inline-block"
              >
