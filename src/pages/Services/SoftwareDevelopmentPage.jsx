...
import { Server, Code, Database, ArrowRight, CheckCircle, Cloud, Shield } from 'lucide-react';
...
const SoftwareDevelopmentPage = () => {
  ...
  const features = [
    {
      ...
      description: 'Scalable software solutions designed for enterprise-level operations and growth.'
    },
    {
      icon: Database,
      title: 'Database Design',
      description: 'Optimized database architecture for efficient data management and security.'
    },
    {
      icon: Cloud,
      title: 'Cloud Solutions',
      description: 'Cloud-native development and migration services for AWS, Azure, and GCP.'
    },
    {
      icon: Shield,
  ...
  const technologies = [
    'Java', 'Python', '.NET', 'Spring Boot', 'Django', 'Node.js', 'PostgreSQL', 'MongoDB', 'Docker', 'Kubernetes'
  ];
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-white/90 text-lg leading-relaxed mb-8">
              Custom software solutions built to streamline your operations and drive business growth. From desktop applications to complex enterprise systems, we deliver robust and scalable software.
            </p>
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl lg:text-5xl font-black text-primary-dark mb-4">
              Our Software <span className="text-white">Services</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                {technologies.map((tech, idx) => (
                  <span key={idx} className="px-6 py-3 bg-white rounded-full text-gray-700 font-bold shadow-sm">
                    {tech}
                  </span>
                ))}
              </div>
            ...
            <div>
              <ul className="space-y-4">
                {['Custom software development', 'Legacy system modernization', 'API development & integration', 'DevOps & CI/CD pipelines', 'Quality assurance & testing'].map((item, idx) => (
