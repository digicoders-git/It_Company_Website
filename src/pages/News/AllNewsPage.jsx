        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-white/10 px-5 py-2.5 rounded-full mb-8"
            >
              <span className="w-2 h-2 rounded-full bg-white animate-pulse" />
              <span className="text-white text-sm font-bold uppercase tracking-wider">News & Insights</span>
            </motion.div>
          ...
          <div className="container">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-primary-blue font-bold uppercase tracking-widest text-sm">Featured Article</span>
              </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="relative h-[400px] lg:h-[500px] overflow-hidden">
                      ...
                      <div className="absolute top-6 left-6 flex items-center gap-2">
                        <div className="bg-primary-blue text-white text-xs font-black uppercase tracking-wider px-4 py-2 rounded-full flex items-center gap-2">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                      ...
                      <h2 className="text-2xl lg:text-4xl font-black text-white leading-tight mb-4 group-hover:text-primary-blue transition-colors">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <img
                            ...
                            className="w-12 h-12 rounded-full object-cover ring-2 ring-primary-blue"
                          />
                          <div>
                        ...
                        <span className="inline-flex items-center gap-2 bg-primary-blue text-white px-6 py-3 rounded-full font-bold text-sm uppercase tracking-wider group-hover:bg-white group-hover:text-primary-dark transition-all">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-10">
            ...
            >
              <input
                ...
                className="w-full bg-white border-2 border-gray-100 py-3.5 pl-5 pr-14 text-sm rounded-2xl focus:outline-none focus:border-primary-blue transition-all shadow-sm"
              />
                        ...
                        <div className="md:col-span-3 p-6 md:p-8 flex flex-col justify-between">
                          <div>
                            ...
                            <Link to={`/news/${post.id}`}>
                              <h3 className="text-lg md:text-xl font-black text-primary-dark leading-snug mb-3 group-hover:text-primary-blue transition-colors line-clamp-2">
                                {post.title}
                              </h3>
                            </Link>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {post.tags.slice(0, 3).map((tag, tIdx) => (
                                <span
                                  key={tIdx}
                                  className="text-xs font-semibold text-gray-500 bg-gray-50 px-3 py-1 rounded-full hover:bg-primary-blue hover:text-white transition-colors cursor-pointer"
                                >
                                  #{tag}
                                </span>
                              ))}
                          ...
                          <div className="flex items-center justify-between mt-5 pt-5 border-t border-gray-100">
                            ...
                            <div className="flex items-center gap-3">
                              <button className="p-2 text-gray-400 hover:text-primary-blue hover:bg-primary-blue/10 rounded-full transition-colors">
                              ...
                              <Link
                                to={`/news/${post.id}`}
                                className="inline-flex items-center gap-2 bg-primary-dark text-white px-5 py-2.5 rounded-full font-bold text-sm uppercase tracking-wider hover:bg-primary-blue transition-colors"
                              >
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="relative">
                  <input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full border-2 border-gray-100 py-3 pl-5 pr-12 text-sm rounded-xl focus:outline-none focus:border-primary-blue transition-colors"
                  />
              ...
              >
                <h4 className="text-lg font-black text-primary-dark mb-6 flex items-center gap-2">
                  <Tag className="h-5 w-5 text-primary-blue" />
                  Categories
                </h4>
                    ...
                    <li key={idx}>
                      <button
                        ...
                        className={`w-full flex items-center justify-between py-3 px-4 rounded-xl font-semibold text-sm transition-all ${
                          activeCategory === cat.name
                            ? 'bg-gradient-to-r from-primary-dark to-primary-blue text-white shadow-lg'
                      ...
                      <Link to={`/news/${post.id}`} className="flex gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                        <div className="relative shrink-0">
                          <img
                            src={post.image}
                            alt={post.title}
                            className="w-20 h-20 object-cover rounded-xl group-hover:ring-2 group-hover:ring-primary-blue transition-all"
                          />
                          <span className="absolute -top-2 -left-2 w-6 h-6 bg-primary-blue text-white text-xs font-black flex items-center justify-center rounded-full">
                            {idx + 1}
                          </span>
                        </div>
                        <div>
                          <h5 className="text-sm font-bold text-primary-dark leading-snug mb-2 group-hover:text-primary-blue transition-colors line-clamp-2">
                            {post.title}
                          </h5>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 bg-primary-blue rounded-2xl flex items-center justify-center mb-4">
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 backdrop-blur-sm border border-white/20 py-3.5 px-5 text-white text-sm placeholder:text-gray-400 rounded-xl focus:outline-none focus:border-primary-blue transition-colors mb-4"
                  />
                  <button className="w-full bg-primary-blue text-white py-3.5 rounded-xl font-bold uppercase tracking-wider hover:bg-white hover:text-primary-dark transition-colors flex items-center justify-center gap-2">
