    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/news" className="text-primary-blue font-bold hover:underline">
            Back to News
          </Link>
        </div>
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {news.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="text-xs font-bold text-gray-600 bg-gray-100 px-4 py-2 uppercase tracking-wider hover:bg-primary-blue hover:text-white transition-colors cursor-pointer"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 font-bold text-sm uppercase tracking-wider transition-all ${
                      liked
                        ...
                        : 'border-2 border-gray-200 text-gray-600 hover:border-primary-blue hover:text-primary-blue'
                    }`}
                  >
                    <ThumbsUp className="h-4 w-4" />
                    {likes} Likes
                  </button>
                  <button className="flex items-center gap-2 border-2 border-gray-200 text-gray-600 px-6 py-3 font-bold text-sm uppercase tracking-wider hover:border-primary-blue hover:text-primary-blue transition-all">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {[Facebook, Twitter, Linkedin].map((Icon, idx) => (
                    <button
                      key={idx}
                      className="h-10 w-10 border-2 border-gray-200 flex items-center justify-center text-gray-600 hover:border-primary-blue hover:bg-primary-blue hover:text-white transition-all"
                    >
              ...
              <div className="mt-12 bg-[#F5F7F9] p-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-primary-blue text-sm font-bold uppercase tracking-wider mb-3">
                      {news.author.role}
                    </p>
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-black text-primary-dark mb-8 pb-4 border-b border-gray-200 relative">
                  Related Articles
                  <span className="absolute bottom-0 left-0 h-[2px] w-16 bg-primary-blue" />
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {relatedPosts.map((post, idx) => (
                    ...
                    >
                      ...
                      <h5 className="text-sm font-black text-primary-dark leading-snug mb-2 group-hover:text-primary-blue transition-colors">
                        {post.title}
                      </h5>
            ...
            <div className="space-y-8">
              ...
              >
                <h4 className="text-lg font-black text-primary-dark mb-6 pb-4 border-b border-gray-200 relative">
                  Recent Posts
                  <span className="absolute bottom-0 left-0 h-[2px] w-10 bg-primary-blue" />
                </h4>
                  ...
                  {relatedPosts.map((post, idx) => (
                    <li key={idx} className="group">
                      <Link to={`/news/${post.id}`} className="flex gap-4">
                        ...
                        />
                        <div>
                          <h5 className="text-sm font-black text-primary-dark leading-snug mb-2 group-hover:text-primary-blue transition-colors line-clamp-2">
                            {post.title}
                          </h5>
                          <span className="text-xs text-gray-400 font-bold uppercase tracking-wider">
                            {post.date}
              ...
              >
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 py-3 px-4 text-white text-sm placeholder:text-gray-500 focus:outline-none focus:border-primary-blue transition-colors mb-3"
                />
